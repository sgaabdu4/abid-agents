...
const PATTERNS = [
  ...
  { level: 'high', id: 'cat-env',        regex: /\b(cat|less|head|tail|more)\s+\.env(?!\.(?:example|sample|template|schema|defaults)\b)(?:\.[A-Za-z0-9_.-]+)?\b/i, reason: 'reading .env/.env.local file exposes secrets' },
