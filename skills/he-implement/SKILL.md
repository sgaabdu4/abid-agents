...
- Run deterministic owners first; violations leave lint/scanner/gate coverage in `guardrails[]`.
...
- Failure loop: stay in `he-implement`; return to `he-plan` only if owner or scope changed.
